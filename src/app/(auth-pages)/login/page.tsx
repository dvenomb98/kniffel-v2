		...
		<section className="page-container items-center w-full lg:w-[600px]">
			<div className="w-full">
				...
				<p className="text-gray h4">
					To access our online game, please Sign in or Sign up,{" "}
					<span className="text-default-color">for free!</span>
				</p>
			</div>

			<div className="w-full border border-divider rounded-md p-5 shadow-lg dark:shadow-secondary-dark/80 shadow-secondary-light">
				<Tabs desktopFullWidth defaultValue="sign-in" tabs={tabs} />
			</div>
		</section>
	);
};
